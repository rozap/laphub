...
config :laphub,
  timeseries_root: "/home/chris/Desktop/laps"
...
config :laphub, LaphubWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "FU+sgnRQYLS0QJQGabqGzllxyI13jevp1ZFJ80CHgxHTXYtlPNwYUd5ZFKhJroKX",
  watchers: [
    # Start the esbuild watcher by calling Esbuild.install_and_run(:default, args)
    esbuild: {Esbuild, :install_and_run, [:default, ~w(--sourcemap=inline --watch)]},
    # https://github.com/sass/dart-sass/releases/tag/1.42.1
    # sass --watch css/app.scss ../priv/static/css/app.css
    sass: [
      "--watch",
